...
window.addEventListener('load', function () {
    ...
    setTimeout(function () {
        iziToast.show({
            ...
            message: '请在阅读<a href="https://al2so43.github.io/backstage/WebsiteUserAgreement.html" target="_blank">『硫酸铝的个人网站---用户协议』</a>之后浏览本站内容!<br />否则因各种原因发生的任何问题的后果将全部由您承担!'
        });
    }, 3000);
    //延迟加载音乐播放器
...
//切换界面
let buttonElement = document.getElementById('page-toggle');
let pageIndicator = document.getElementById('totalpages');
buttonElement.addEventListener('click', function() {
    let page1 = document.getElementById('page1');
    let page2 = document.getElementById('page2');
    if (pageIndicator.textContent === '第1/2页') {
        page1.style.display = 'none';
        page2.style.display = 'block';
        pageIndicator.textContent = '第2/2页';
    } else {
        page1.style.display = 'block';
        page2.style.display = 'none';
        pageIndicator.textContent = '第1/2页';
    }
});
...
var startDate = new Date('2023-10-05T16:30:00');
